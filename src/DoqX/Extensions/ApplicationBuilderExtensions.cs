...
namespace DoqX
{
    ...
    {
        public static IApplicationBuilder UseDoqX(this IApplicationBuilder app)
        {
        ...
        private static IApplicationBuilder UseXFileServer(this IApplicationBuilder app)
        {
            ...
            app.UseFileServer(new FileServerOptions
            {
                ...
                FileProvider = new EmbeddedFileProvider(typeof(ApplicationBuilderExtensions).GetTypeInfo().Assembly, "DoqX.www")
            });
            return app;
        }
